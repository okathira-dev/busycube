...
const stageMatchers = [
  ...
  [/Canvas|Screen Capture|MediaRecorder|MediaStream Recording/i, ["S-190"]],
  ...
  [/HTMLMediaElement/i, ["S-350"]],
  [/^Picture-in-Picture/i, ["S-350"]],
...
function disposition(name, status = {}) {
  ...
  if (stageIds.length)
    return {
      disposition: "stage",
      stageIds,
      reason: "Implemented as an observable Busycube mechanic.",
    };
...
const output = resolve("src/data/api-ledger.json");
